    ...
    public class TwentyOne : Game, IWalkAway
    {
        ...
        public override void Play()
        {
            ...
            foreach (Player player in Players)
            {
                ...
                Bets[player] = bet;
                Console.WriteLine("{0} bet " + bet + ", and has a remaining balance of " + player.Balance + ".", player.Name);
                Console.ReadLine();
            }
            for (int i = 0; i < 2; i++)
            {
                ...
                foreach (Player player in Players)
                {
                    ...
                    if(i == 1)
                    {
                        ...
                        if (blackJack)
                        {
                            ...
                            player.Balance = player.Balance + Convert.ToInt32((Bets[player] * 1.5) + Bets[player]);
                            return;
                        }
                    }
                }
                ...
                if (i == 1)
                {
                    ...
                    if (blackJack)
                    {
                        ...
                        {
                            Dealer.Balance = Dealer.Balance + entry.Value;
                        }
                        return;
                    }
                }
